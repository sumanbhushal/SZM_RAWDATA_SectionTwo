...
namespace WebApplication.Controllers
{
    public class PostsCommentsController : ApiController
    {
        ...
        public IHttpActionResult Get(int postId, int page = 0, int pagesize = Config.DefaultPageSize)
        {
            ...
            var listOfComment = _repository.GetCommentsByPostId(postId,limit, offset).Select(c => ModelFactory.Map(c, Url));
            var totalComment = _repository.GetNumberOfCommentsByPostId(postId);
